...
const TwoTokenLogin1SettingsForm = ({ formData: initialData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
        ...
        >
            <div className='relative w-full'>
                <Form>
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="headerAreaShadow" className="text-blue-100  text-xs">ID 誕生日入力エリア配色</label>
                        <div className="flex justify-start space-x-4">
                            <ColorPickerWithRecent
                                labelClassName="text-[10px] text-blue-100"
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="headerAreaShadow" className="text-blue-100  text-xs">ID配色</label>
                        <div className="flex justify-start space-x-4">
                            <ColorPickerWithRecent
                                labelClassName="text-[10px] text-blue-100"
                                setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.textColor, [1, 2])}
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="headerAreaShadow" className="text-blue-100  text-xs">誕生日配色</label>
                        <div className="flex justify-start space-x-4">
                            <ColorPickerWithRecent
                                labelClassName="text-[10px] text-blue-100"
                                setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.textColor, [1, 2])}
                    ...
                    <InputContainer>
                        <TextBox label="誕生日右側月日表示カスタムClass"
                            labelClassName='text-blue-100 text-xs'
                            inputClassName='bg-blue-25'
                    ...
                    <InputContainer>
                        <TextBox label="ID 誕生日下エラーメッセージカスタムClass"
                            labelClassName='text-blue-100 text-xs'
                            inputClassName='bg-blue-25'
                    ...
                    <InputContainer>
                        <TextBox label="誕生日WrapカスタムClass"
                            labelClassName='text-blue-100 text-xs'
                            inputClassName='bg-blue-25'
...
export default TwoTokenLogin1SettingsForm