...
const H6Settings = ({ formData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
    ...
    function handleOnChangePrefix(e, attr) {
        ...
        currentStateDataUpdate.tabItems.settings.appSettingQuery.h6Settings.prefixClass[objName][objIndex] = attrValue;
