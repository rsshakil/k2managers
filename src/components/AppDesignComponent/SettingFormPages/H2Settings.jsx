...
const H2Settings = ({ formData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
    ...
    function handleOnChangePrefix(e, attr) {
        ...
        currentStateDataUpdate.tabItems.settings.appSettingQuery.h2Settings.prefixClass[objName][objIndex] = attrValue;
