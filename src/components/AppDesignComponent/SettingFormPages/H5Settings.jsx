...
const H5Settings = ({ formData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
    ...
    function handleOnChangePrefix(e, attr) {
        ...
        currentStateDataUpdate.tabItems.settings.appSettingQuery.h5Settings.prefixClass[objName][objIndex] = attrValue;
