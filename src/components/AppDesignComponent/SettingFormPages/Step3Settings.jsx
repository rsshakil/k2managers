...
import {
    borderAttributes, fontSizeAttributes, fontWeightAttributes, letterSpacingAttributes, positionAttributes, textAlignAttributes, verticalAlignAttributes
} from "../../../lib/tailwindClassAttributes";
import { appDesignerState, getSelectedPageData } from "../../../store/recoil/appDesignerState";

const Step3Settings = ({ formData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
    ...
    const handleChangeLoopField = async (e) => {
        ...
        let objIndex = getAttrNameFromArr[1]; 
        let currentStateDataUpdate = JSON.parse(JSON.stringify({ ...recoilStateValue }));
        currentStateDataUpdate.tabItems.settings.appSettingQuery.step3Settings.info.stepBoxText[objIndex].text = attrValue;
            ...
            <div className='relative w-full h-full'>
                <Form>
                    ...
                    <FormBodyContainer height="!px-0">
                        ...
                        {initialValues?.stepBoxText && initialValues?.stepBoxText.length > 0 &&
                            initialValues.stepBoxText.map((field, index) => (
                                <InputContainer>
                                    <TextBox label={`ステップ１BOX${index + 1}テキスト（16文字まで）`}
                                        labelClassName='text-blue-100 text-xs'
                                        inputClassName='bg-blue-25'
                        ...
                        <div className="flex flex-col mb-4">
                            <label htmlFor="headerAreaShadow" className="text-blue-100 text-xs">ステップ１　配色　活性時</label>
                            <div className="flex justify-start">
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.backgroundColor, [1, 2])} inputBoxItem="activeBackgroundColor" pickerLabel="背景色" isBackgroundColor="1" isDefaultColor={initialValues.activeBackgroundColor?.backgroundColor} />
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.borderColor, [1, 2])} inputBoxItem="activeBorderColor" pickerLabel="線色" isBackgroundColor="1" isDefaultColor={initialValues.activeBorderColor?.borderColor} />
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.textColor, [1, 2])} inputBoxItem="activeTextColor" pickerLabel="文字色" isBackgroundColor="1" isDefaultColor={initialValues.activeTextColor?.color} />

                            </div>
                        </div>
                        <div className="flex flex-col mb-4">
                            <label htmlFor="headerAreaShadow" className="text-blue-100 text-xs">ステップ１　配色　非活性時</label>
                            <div className="flex justify-start">
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.backgroundColor, [1, 2])} inputBoxItem="disableBackgroundColor" pickerLabel="背景色" isBackgroundColor="1" isDefaultColor={initialValues.disableBackgroundColor?.backgroundColor} />
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.borderColor, [1, 2])} inputBoxItem="disableBorderColor" pickerLabel="線色" isBackgroundColor="1" isDefaultColor={initialValues.disableBorderColor?.borderColor} />
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.textColor, [1, 2])} inputBoxItem="disableTextColor" pickerLabel="文字色" isBackgroundColor="1" isDefaultColor={initialValues.disableTextColor?.color} />
                        ...
                        <InputContainer>
                            <TextBox label="ステップ1　WrapカスタムClass"
                                labelClassName='text-blue-100 text-xs'
                                inputClassName='bg-blue-25'
                        ...
                        <InputContainer>
                            <TextBox label="ステップ1　BOXカスタムClass"
                                labelClassName='text-blue-100 text-xs'
                                inputClassName='bg-blue-25'
                                name='boxCustomClass'
                                onBlur={(e) => handleOnChange(e, 1)}
