...
import {
    borderAttributes, borderRadiousAttributes, borderStyles, fontSizeAttributes, fontWeightAttributes, heightAttributes, letterSpacingAttributes, paddingXAttributes,
    paddingYAttributes, shadowAttributes, textAlignAttributes, verticalAlignAttributes
} from "../../../lib/tailwindClassAttributes";
import { appDesignerState, getSelectedPageData } from "../../../store/recoil/appDesignerState";

const H3Settings = ({ formData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
    ...
    function handleOnChangePrefix(e, attr) {
        ...
        currentStateDataUpdate.tabItems.settings.appSettingQuery.h3Settings.prefixClass[objName][objIndex] = attrValue;
                    ...
                    <FormBodyContainer height="!px-0">
                        ...
                        <div className="flex flex-col mb-4">
                            ...
                            <div className="flex justify-start">
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.textColor, [1, 2])} inputBoxItem="textColor" pickerLabel="文字色" isBackgroundColor="1" isDefaultColor={initialValues.textColor?.color} />
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.backgroundColor, [1, 2])} inputBoxItem="backgroundColor" pickerLabel="背景色" isBackgroundColor="1" isDefaultColor={initialValues.backgroundColor?.backgroundColor} />
                                <ColorPickerWithRecent setColorhandle={(_, name, colorCode) => handleOnChangeColor(name, colorCode, tailwindColorCodeKeys.borderColor, [1, 2])} inputBoxItem="borderColor" pickerLabel="線色" isBackgroundColor="1" isDefaultColor={initialValues.borderColor?.borderColor} />
