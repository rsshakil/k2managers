...
const CheckboxIconSettingForm = ({ formData: initialData, handleOnChange, handleOnChangeColor = () => { }, updateState, tailwindColorCodeKeys }) => {
...
export default CheckboxIconSettingForm