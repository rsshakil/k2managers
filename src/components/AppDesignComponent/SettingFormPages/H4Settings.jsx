...
const H4Settings = ({ formData, handleOnChange, handleOnChangeColor = () => { }, tailwindColorCodeKeys }) => {
    ...
    function handleOnChangePrefix(e, attr) {
        ...
        currentStateDataUpdate.tabItems.settings.appSettingQuery.h4Settings.prefixClass[objName][objIndex] = attrValue;
