...
export default function ZipCodeSearch({ blockData = '', setModalOpen = () => { }, handleOnPressSave = () => { }, fieldKey = '' }) {
    ...
    return (
        <WhiteModalWrapper width="border-none text-black" className="items-start">
            <ModalTitle title="郵便番号検索設定" className="text-blue-100 text-xl" />
