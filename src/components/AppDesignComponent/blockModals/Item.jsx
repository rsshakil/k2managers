...
export default function Item({ blockData = '', setModalOpen = () => { }, handleOnPressSave = () => { }, fieldKey = '' }) {
        ...
        <WhiteModalWrapper width="border-none text-black" className="items-start">
            ...
            <Formik enableReinitialize={true} initialValues={formData}>
                <div className="relative w-full h-full">
                    <Form onChange={handleOnchange}>
                        <div className="body-height3 pt-12 px-10 min-h-[calc(100vh-452px)] !p-0">
                            <div className="flex flex-col py-10">
                                ...
                                <label className="text-blue-100">表示するアイテムが無い時の情報エリア設定</label>
                                <TreeListCustom
                                    config={{
                                ...
                                <InputContainer>
                                    <SelectBox
                                        label="表示可能アイテムが0個の時true,0個以外の時にfalseを書き込むフィールド"
                                ...
                                <InputContainer>
                                    <SelectBox
                                        label="アイテムフィルターNGの時false、OKの時trueを書き込むフィールド(初期値はfalse)"
                                        name={`itemFilterTargetField`}
                                        labelClassName="text-blue-100"
                                        inputClassName="bg-blue-25"
                                    >
                                        <option value="">記録しない</option>
                    ...
                    {modalOpen1 && selectedBlock1.key === 'INFORMATION_AREA' && (
