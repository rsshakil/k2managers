...
export default function ReservationModalBlockForm({ blockData = '', setModalOpen = () => { }, handleOnPressSave = () => { }, fieldKey = '', selectedButton = 1 }) {
    ...
    return (
        <WhiteModalWrapper width="border-none text-black" className="items-start">
            <ModalTitle title={`Your modal title`} className="text-blue-100 text-xl" />
