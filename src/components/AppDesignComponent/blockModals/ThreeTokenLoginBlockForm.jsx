...
export default function ThreeTokenLoginBlockForm({
    blockData = '',
    divisionNumber = '',
    setModalOpen = () => {},
    handleOnPressSave = () => {},
    ...
    return (
        <WhiteModalWrapper width="border-none text-black" className="items-start">
            <ModalTitle title="3トークンログインブロック設定（トークン2は年月日）" className="text-blue-100 text-xl" />
                        ...
                        <div className="body-height3 pt-12 px-10 min-h-[calc(100vh-452px)] !p-0">
                            <div className="flex flex-col py-10">
                                                        ...
                                                        <div className="w-1/5 px-2">
                                                            <InputContainer>
                                                                ...
                                                                >
                                                                    ...
                                                                    />
                                                                    {/* {dropdownArrayList[index].map((n,i)=> <option key={i} value={i}>{padDigits(i,areaLength[index])}</option>)} */}
                                                                </SelectBox>
                                                            </InputContainer>
                                                        </div>
                                ...
                                <div className="flex px-8">
                                    ...
                                    {formData?.t3InputType == 0 && (
                                        <>
                                            <div className="w-1/5 px-2">
                                                <InputContainer>
                                                    <SelectBox
                                                        label={`ドロップダウン開始数（ゼロ埋め） `}
                                                        name={`t3DropdownStartNumber`}
                                                        labelClassName="text-blue-100 text-xs"
                                                        inputClassName="bg-blue-25"
                                                        onChange={handleOnchange}
                                                    >
                                                        <TokenLoginInputOptions numOfOptions={formData?.t3TextLength} />
                                                    </SelectBox>
                                                </InputContainer>
                                            </div>
