...
import TreeList, { Column, RowDragging, Button } from 'devextreme-react/tree-list';
            ...
            >
                ...
                {columns.map((column) => (
                    <Column
                        ...
                        dataEventType={column.eventType}
                        dataHandleOnClick={column.handleOnClick}
                        cssClass={column.classes}
                    ></Column>
                ))}
